...
use imyangjin\objectStorageUpload\services\uploads\UploadServiceInterface;
...
{
    public const OSS_TYPE = 1;  //oss

    public const COS_TYPE = 2;  //cos

    public const BLOB_TYPE = 3;  //Azure Blob 存储

    public const LOCAL_TYPE = 4;
     ...
     *
     * @return string
     * @throws ValidationException|\Illuminate\Contracts\Container\BindingResolutionException
     */
